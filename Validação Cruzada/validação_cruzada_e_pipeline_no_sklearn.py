...
Original file is located at
    https://colab.research.google.com/drive/141Kdyh9duqPt2dT_Jgduw4NsAxStFe_H
...
"""#2 - Transformando a base de dados:"""
...
x=tabela_dados.drop(columns=["diagnostic"]) # para utilizar para treino, tudo menos o target.
...
#treinado o modelo com dados sem escalonamento
...
"""#7 - Testando o KNN com validação cruzada:
...
"""#8 - Testando vários tipos de algoritmos de classificação:"""
